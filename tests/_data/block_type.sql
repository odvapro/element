...
INSERT INTO `block_type` (`id`, `value`,`phone`, `name`, `node`, `file`, `text`, `date`, `datetime`, `matrix`, `int`, `flag`)
VALUES
  (1,'text','1234','text',NULL,NULL,'Lorem ipsum <br/> </div> dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',NULL,NULL,NULL,10,'0'),
